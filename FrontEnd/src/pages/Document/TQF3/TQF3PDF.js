...
import { Page, Text, Document, Font, Image, PDFDownloadLink ,StyleSheet } from '@react-pdf/renderer';
// import { StyleSheet } from '@react-pdf/styled-components';
import THSarabunNew from '../../../assert/fonts/THSarabunNew.ttf'
import THSarabunNewBold from '../../../assert/fonts/THSarabunNewBold.ttf'
...
export default function TQF3PDF() {
  return (
    <PDFDownloadLink
    document={<MyDocument/>}
